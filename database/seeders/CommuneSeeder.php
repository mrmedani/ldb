...
class CommuneSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($communes as $wilayaCode => $names) {
            $wilayaId = \App\Models\Wilaya::where('code', str_pad($wilayaCode, 2, '0', STR_PAD_LEFT))->value('id');
            if ($wilayaId) {
                foreach ($names as $name) {
                    Commune::create(['wilaya_id' => $wilayaId, 'name' => $name]);
                }
            }
        }
    }
